...
const _OSName_name = "OSUnknownOSWindowsPhoneOSWindowsOSMacOSXOSiOSOSAndroidOSBlackberryOSChromeOSOSKindleOSWebOSOSLinuxOSPlaystationOSXboxOSNintendoOSBotOSAppleTVOSGoogleTVOSRokuOS"

var _OSName_index = [...]uint8{0, 9, 23, 32, 40, 45, 54, 66, 76, 84, 91, 98, 111, 117, 127, 132, 141, 151, 159}
...
func _() {
	...
	_ = x[PlatformBot-12]
	_ = x[PlatformAppleTV-13]
	_ = x[PlatformGoogleTV-14]
	_ = x[PlatformRokuTV-15]
}

const _Platform_name = "PlatformUnknownPlatformWindowsPlatformMacPlatformLinuxPlatformiPadPlatformiPhonePlatformiPodPlatformBlackberryPlatformWindowsPhonePlatformPlaystationPlatformXboxPlatformNintendoPlatformBotPlatformAppleTVPlatformGoogleTVPlatformRokuTV"

var _Platform_index = [...]uint8{0, 15, 30, 41, 54, 66, 80, 92, 110, 130, 149, 161, 177, 188, 203, 219, 233}
