...
var testUAVars = []struct {
	...
	{"AppleCoreMedia/1.0.0.19J581 (Apple TV; U; CPU OS 15_1_1 like Mac OS X; en_us)", // AppleTV
		UserAgent{
			Browser{BrowserUnknown, Version{0, 0, 0}}, OS{PlatformAppleTV, OSAppleTV, Version{0, 0, 0}}, DeviceTV}},
